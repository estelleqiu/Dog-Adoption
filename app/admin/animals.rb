...
# https://github.com/activeadmin/activeadmin/blob/master/docs/2-resource-customization.md#setting-up-strong-parameters
  permit_params :name, :animal_type, :birth_date, :gender, :variety, :character, :is_sterilized, :is_vaccined, :description, :size, :file, media_attributes: [:id, :medium_type, :mediable_type, :mediable_id, :_destroy, :url, :file]
  form partial: 'form'
  ...
  controller do
    ...
    def update_avatar_image
      ...
      params[:animal][:file].each do |f|
        key = params[:animal][:name] + f.original_filename # 上传到七牛后保存的文件名
